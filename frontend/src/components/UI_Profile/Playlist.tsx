...
import handlePlayTrack, {initFirstWaveforms } from "../../hooks/Manager_Playlist"; // Đảm bảo đường dẫn này đúng
    ...
    <div className="content playlist">
      {playlists.map((playlist, index) => (
        <div
          ...
          key={index}
          data-playlist={JSON.stringify(playlist)} // Lưu trữ thông tin playlist dưới dạng JSON
        >
              ...
              <div className="track-list">
                {playlist.tracks.map((track, i) => (
                  <div
                    ...
                    key={i}
                    onClick={handlePlayTrack} // Sử dụng hàm xử lý sự kiện từ Manager_Playlist.js
                  >

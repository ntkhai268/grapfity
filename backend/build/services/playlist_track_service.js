  ...
  try {
    const playlist = await db.Playlist.findByPk(numericPlaylistId, {
      ...
      include: [{
        ...
        // Quan trọng: Không lấy các trường từ bảng PlaylistTrack
        ...
        // <<< LỒNG INCLUDE CHO TRACK
        {
          ...
          model: db.Metadata,
          attributes: [
          // <<< Lấy các trường cần từ Metadata
          'trackname', 'duration_ms', 'lyrics'
...
// getTracksInPlaylist,
getPlaylistDetailsById, getPlaylistDetailsByIdforme };
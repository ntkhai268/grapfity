...
import { getMyPlaylistsController, getPublicPlaylistsController, getAllPublicPlaylistsController, createPlaylistController, deletePlaylistController, updatePlaylistController, uploadPlaylistCoverController } from '../controllers/playlistController.js';
...
router.post('/:playlistId/upload-cover',
// Đường dẫn riêng cho việc upload ảnh bìa
authenticateUser,
// Cần xác thực người dùng
uploadPlaylistImage,
// Middleware multer xử lý file upload trước controller
